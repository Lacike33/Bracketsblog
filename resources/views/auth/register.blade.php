            ...
            <div class="row">
                <div class="col-lg-8 col-md-10 mx-auto">
                    <div class="site-heading">
                        <h1>Registrácia</h1>
                        <span class="subheading">@yield('subhead', 'Registrácia nového užívateľa.')</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                {{--<div class="card-body">--}}
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group row">
                            <label for="firstname" class="col-md-6 col-form-label text-md-right">{{ __('First Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="lastname" class="col-md-6 col-form-label text-md-right">{{ __('Last Name') }}</label>

...
@section('content')
    ...
    <div class="container">
        ...
        <ul>
            ...
            <li>po kliknutí na tag, vylistovať zoznam blogov s danym tagom</li>
        </ul>
        ...
        <h4>FRONTEND</h4>
        <p>
            Ako základný Layout som použil Temlate na technológii <a href="https://getbootstrap.com">Bootsrtap v4.1</a>,
        ...
        <p>Aplikácia je nasadená na živý server za pomoci Heroku a automatického <strong>DEPLOY</strong> a aplikácia je
            dostupná na <a href="https://mojprvyblog.herokuapp.com">www.mojprvyblog.herokuapp.com</a></p>
        ...
        <p>V blogu je možné pridávať nové posty , len registrovaným užívateľom, a navyše Post je možné aj editovať
            užívateľom, ktorý Post vytvoril.</p>
    </div>
